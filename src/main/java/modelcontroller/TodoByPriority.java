...
public class TodoByPriority implements Comparator<Todo> {
  ...
  public int compare(Todo o1, Todo o2) {
    if ((int)o1.getPriority().charAt(0) < (int)o2.getPriority().charAt(0)){
      return -1;
    }else if ((int)o1.getPriority().charAt(0) > (int)o2.getPriority().charAt(0)){
      return 1;
    }
    return 0;
  }
